...
- [Scheduling Algorithm](architecture/scheduling-algorithm.md)
- [CLI Design](architecture/cli-design.md)
- [Telemetry](architecture/telemetry.md)
- [Observability](architecture/observability.md)
- [Security](architecture/security.md)
- [Deployment & Bootstrapping](architecture/deployment.md)
- [Failure Modes and Recovery](architecture/failure-modes.md)
- [Upgrades and Rollouts](architecture/upgrades.md)
- [Testing Strategy](architecture/testing-strategy.md)

# Scheduling

- [DAG Scheduling](architecture/dag-scheduling.md)
- [Preemption Policy](architecture/preemption.md)
- [Checkpoint Broker](architecture/checkpoint-broker.md)
...
- [Sensitive Workloads](architecture/sensitive-workloads.md)
- [Accounting](architecture/accounting.md)

# Operations

- [Slurm Migration](architecture/slurm-migration.md)
